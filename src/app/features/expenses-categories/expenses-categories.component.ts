...
@Component({
  ...
  styleUrls: ['./expenses-categories.component.scss']
})
export class ExpensesCategoriesComponent implements OnInit, OnDestroy {
  ...
  // Table Options
  displayedColumns = ['expenseCategoryName','action'];
  ...
  constructor(private _service : ExpensesCategoriesService,
