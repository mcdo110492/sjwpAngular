...
@Component({
  selector: 'app-services-categories-editor',
  templateUrl: './services-categories-editor.component.html'
})
export class ServicesCategoriesEditorComponent implements OnInit {
